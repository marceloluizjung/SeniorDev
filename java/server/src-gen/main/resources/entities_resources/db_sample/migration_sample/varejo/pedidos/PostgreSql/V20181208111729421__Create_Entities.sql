/* Database: PostgreSql. Generation date: 2018-12-08 11:17:29:421 */
/* Entity Cliente */
...
alter table pedido add constraint fk67z8byzdcfwwfawwldkgs0c63bps foreign key (cliente) references cliente (id);
alter table pedido_itens add constraint fkbxjldvegskcdtl9kfp72tjorwe7d foreign key (pedido_id) references pedido (id);
alter table pedido_itens add constraint fk8zhwb8mo1dpdnucf6bdiopuoi4th foreign key (itens_id) references item (id);
