...
public class EmailNotifyUserEventPayload extends NotifyUserEventPayload {
     ...
     */
    public EmailNotifyUserEventPayload(String notificationOrigin, UserNotificationKind notificationKind, UserNotificationPriority notificationPriority, String notificationSubject, String notificationContent, String sourceDomain, String sourceService, String destinationUser, String link, String from, java.util.List<String> sendTo, EventEmailFormat format) {
